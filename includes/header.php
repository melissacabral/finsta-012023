			...
			<nav>
				...
				<div class="menu">
					<?php if( $logged_in_user ){ ?>
						<a href="#" class="pseudo button"><?php echo $logged_in_user['username']; ?></a>
						<a href="new-post.php" class="pseudo button">New Post</a>
						<a href="login.php?action=logout" class="pseudo button">Log Out</a>
					<?php }else{ ?>
						<a href="login.php" class="pseudo button">Log In</a>
						<a href="register.php" class="pseudo button">Sign Up</a>
					<?php } ?>
